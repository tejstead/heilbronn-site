/-
Convex-combination composition lemmas used by hull classification:
vertices lie in their own triangle, and triangle membership is absorbed
through triangles whose vertices lie in a common triangle.
-/
