...
import Heilbronn8.Survivors.Join.HullSixThreeThreeQBlindQ113ScalarAMGM
...
/-!
# Geometric adapter for the q-blind `011 / 113` chambers

At a rotated oriented `3 + 3` frame, this branch uses the seven signed cross
floors `-X00`, `X10`, `-Y01`, `-Y11`, `+Y21`, `-Y12`, and `+Y22`.
Line-level and boundary floors supply all remaining hypotheses of
`hullSixThreeThreeQ113_scalar`.  The normalized determinant-coordinate seam
then reconstructs its strict conclusion as the six-term `P`-fan sum,
contradicting the beating margin.

The `011 / 013` wrapper has an `R` cell at `(0,0)`.  Base change and the two
line-level floors strengthen that cell to `X00 <= -3m`, so it feeds the same
core theorem as `011 / 113`.
-/
...
private lemma threeThree_q113_shiftedBoundary_floor
...
/-- The seven signed cells used by the q-blind `011 / 113` scalar
certificate are incompatible with a beating compact residual. -/
theorem threeThreeQ113At_false_of_crossFloors
    {cfg : Configuration} {cycle : Fin 6 → Fin 8} {p q P Q : Fin 8}
    (R : HullSixCompactCrossChordResidual cfg cycle p q)
    (V : HullSixOrientedView cfg cycle P Q)
    (rotation : Fin 6)
  ...
  have htRaw : m ≤ sig (cfg P) U1 U2 := by
    simpa [m, U1, U2, hullSixThreeThreeUpperOffset] using
      threeThree_q113_shiftedBoundary_floor R V P V.P_outside
        V.P_boundary_pos rotation 1
  have hl1qRaw : m ≤ sig (cfg Q) L1 L2 := by
    simpa [m, L1, L2, hullSixThreeThreeLowerOffset] using
      threeThree_q113_shiftedBoundary_floor R V Q V.Q_outside
  ...
  have hscalar :
      (25 : ℝ) / 2 <
        a * b * (r + s) + b * c * t + c * d * (s + t) +
          d * e * (s + t + w) + e * f * z +
            a * f * (r + s + t + w + z) :=
    hullSixThreeThreeQ113_scalar ha1 hb1 hc1 hd1 he1 hf1
      hr hs ht hl1q hY01neg hY11neg hY21pos hY12neg hY22pos
...
/-- The signed q-blind branch `p = 011`, `q = 113`. -/
def q113 : HullSixThreeThreeCuts where
  p0 := 0
  p1 := 1
  p2 := 1
  q0 := 1
...
/-- The signed q-blind branch `p = 011`, `q = 013`. -/
def q013 : HullSixThreeThreeCuts where
  p0 := 0
  p1 := 1
  p2 := 1
  q0 := 0
...
/-- Ferrers-table wrapper for the `011 / 113` branch. -/
theorem threeThreeQ113At_false
    {cfg : Configuration} {cycle : Fin 6 → Fin 8} {p q P Q : Fin 8}
    (R : HullSixCompactCrossChordResidual cfg cycle p q)
    (V : HullSixOrientedView cfg cycle P Q)
    (rotation : Fin 6)
    ...
    (hQ113 : ∀ i j : Fin 3,
      HullSixChamberLabel.Holds
        (HullSixThreeThreeCuts.q113.table i j) (minTri cfg)
        (sig (cfg P)
          (cfg (cycle (rotation + hullSixThreeThreeUpperOffset i)))
  ...
  have h12 := hQ113 1 2
  have h22 := hQ113 2 2
  rw [show HullSixThreeThreeCuts.q113.table 0 0 =
    HullSixChamberLabel.M by decide] at h00
  rw [show HullSixThreeThreeCuts.q113.table 1 0 =
    HullSixChamberLabel.L by decide] at h10
  rw [show HullSixThreeThreeCuts.q113.table 0 1 =
    HullSixChamberLabel.R by decide] at h01
  rw [show HullSixThreeThreeCuts.q113.table 1 1 =
    HullSixChamberLabel.R by decide] at h11
  rw [show HullSixThreeThreeCuts.q113.table 2 1 =
    HullSixChamberLabel.M by decide] at h21
  rw [show HullSixThreeThreeCuts.q113.table 1 2 =
    HullSixChamberLabel.R by decide] at h12
  rw [show HullSixThreeThreeCuts.q113.table 2 2 =
    HullSixChamberLabel.M by decide] at h22
  simp only [HullSixChamberLabel.Holds] at h00 h10 h01 h11 h21 h12 h22
  exact R.threeThreeQ113At_false_of_crossFloors V rotation hupper hlower
    h00.1 h10 h01 h11 h21.2 h12 h22.2

/-- Ferrers-table wrapper for the `011 / 013` branch.  Its `(0,0)` `R`
cell is strengthened on the `P` side by line-level base change. -/
theorem threeThreeQ013At_false
    {cfg : Configuration} {cycle : Fin 6 → Fin 8} {p q P Q : Fin 8}
    (R : HullSixCompactCrossChordResidual cfg cycle p q)
    (V : HullSixOrientedView cfg cycle P Q)
    (rotation : Fin 6)
    ...
    (hQ013 : ∀ i j : Fin 3,
      HullSixChamberLabel.Holds
        (HullSixThreeThreeCuts.q013.table i j) (minTri cfg)
        (sig (cfg P)
          (cfg (cycle (rotation + hullSixThreeThreeUpperOffset i)))
          (cfg (cycle (rotation + hullSixThreeThreeLowerOffset j))))
        (sig (cfg Q)
  ...
  have h12 := hQ013 1 2
  have h22 := hQ013 2 2
  rw [show HullSixThreeThreeCuts.q013.table 0 0 =
    HullSixChamberLabel.R by decide] at h00
  rw [show HullSixThreeThreeCuts.q013.table 1 0 =
    HullSixChamberLabel.L by decide] at h10
  rw [show HullSixThreeThreeCuts.q013.table 0 1 =
    HullSixChamberLabel.R by decide] at h01
  rw [show HullSixThreeThreeCuts.q013.table 1 1 =
    HullSixChamberLabel.R by decide] at h11
  rw [show HullSixThreeThreeCuts.q013.table 2 1 =
    HullSixChamberLabel.M by decide] at h21
  rw [show HullSixThreeThreeCuts.q013.table 1 2 =
    HullSixChamberLabel.R by decide] at h12
  rw [show HullSixThreeThreeCuts.q013.table 2 2 =
    HullSixChamberLabel.M by decide] at h22
  simp only [HullSixChamberLabel.Holds] at h10 h01 h11 h21 h12 h22
  ...
  exact R.threeThreeQ113At_false_of_crossFloors V rotation hupper hlower
    (by simpa [U0, L0] using hX00) h10 h01 h11 h21.2 h12 h22.2
